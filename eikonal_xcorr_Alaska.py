...
#initialization
#-----------------------
dset    = eikonaltomo.EikonalTomoDataSet('/work1/leon/ALASKA_work/hdf5_files/eikonal_xcorr_tomo_Alaska_TA_AK_20190218_250km.h5')
...
# #------------------------------
# dset.xcorr_eikonal_mp_lowmem(inasdffname='/work1/leon/ALASKA_work/ASDF_data/xcorr_Alaska_20190218.h5', \
#                 workingdir='/work1/leon/ALASKA_work/eikonal_working_TA_AK_20190218', \
...
#------------------------------
# dset.compare_raytomo('/work1/leon/ALASKA_work/hdf5_files/ray_tomo_Alaska_20190227.h5', 1, 2, 0, 10.)
