...
import numpy as np
import timeit
dset=ASDFDBase.quakeASDF('./DPRK_2006.h5')
# dset.get_events(startdate='2006-10-09', enddate='2006-10-10', Mmin=2.5, latitude=41.28, longitude=129.1, maxradius=1)
# 
# 
# 
# channel = 'BHZ'
# dset.get_stations(channel=channel, station='BJT')
# dset.get_stations(channel=channel, station='HIA')
# dset.get_stations(channel=channel, station='ENH')
# dset.get_stations(channel=channel, station='TATO')
# dset.get_stations(channel=channel, station='LSA')
# 
# 
# dset.get_surf_waveforms( channel=channel)
