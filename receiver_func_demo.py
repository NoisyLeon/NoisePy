...
dset=quakedbase.quakeASDF('../ref_AK.BESE.h5')
# # # # Retrieving earthquake catalog
dset.get_events(startdate='2003-09-01', enddate='2012-12-31', Mmin=5.5, magnitudetype='mb', add2dbase=True)
# # # # # # Getting station information
dset.get_stations(channel='BH*', station='BESE', network='AK')
# # # # # Downloading data
