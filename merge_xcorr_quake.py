...
#initialization
#-----------------------
dset    = eikonaltomo.hybridTomoDataSet('/work1/leon/ALASKA_work/hdf5_files/eikonal_hybrid_20190227.h5')
...
#-----------------------------------------------
# dset.read_xcorr(inh5fname = '/work1/leon/ALASKA_work/hdf5_files/eikonal_xcorr_tomo_Alaska_TA_AK_20190218_250km.h5')
...
#-----------------------------------------------
# dset.merge_raytomo(inrayfname='/work1/leon/ALASKA_work/hdf5_files/ray_tomo_Alaska_20190228.h5', inrunid=2, \
