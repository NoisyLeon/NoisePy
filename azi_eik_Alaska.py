...
# dset    = eikonaltomo.EikonalTomoDataSet('/work1/leon/ALASKA_work/hdf5_files/eikonal_xcorr_tomo_Alaska_all_20190317_250km_azi_all_periods_new.h5')
...
# # # # # # #------------------------------
# # 
# dset.eikonal_stack_new(anisotropic=True, spacing_ani=2., N_bin=20)
