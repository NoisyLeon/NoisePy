...
# dset=quakedbase.quakeASDF('/scratch/summit/life9360/WUS_quake_002.h5')
...
import eikonaltomo
# # # 
dset=eikonaltomo.EikonalTomoDataSet('/scratch/summit/life9360/eikonal_quake_debug_green.h5')
...
#             data_type='FieldDISPpmf2interp', amplplc=True, cdist=None, deletetxt=False)
# dset.quake_eikonal_debug(inasdffname='/scratch/summit/life9360/WUS_quake_002.h5', workingdir='/scratch/summit/life9360/eikonal_working_single', fieldtype='Tph', channel='Z',
#             data_type='FieldDISPpmf2interp', amplplc=True, cdist=None, deletetxt=False)
# 
...
# cb.set_label('C (km/s)', fontsize=25, rotation=0)
...
# cb      = m.colorbar(im, "bottom", size="3%", pad='2%')
# cb.ax.tick_params(labelsize=20)
# cb.set_label('Amplitude Laplacian term ', fontsize=25, rotation=0)
################
