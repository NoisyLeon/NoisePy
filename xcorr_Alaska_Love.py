...
# dset.xcorr_raytomoinput(outdir='/work1/leon/ALASKA_work/xcorr_working_dir/raytomo_input_20190131_all_three_lambda')
# dset.xcorr_get_field(outdir='../eikonal_working_dir', staxml='/home/leon/code/DataRequest/ALASKA_TA_AK.xml')
