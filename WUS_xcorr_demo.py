...
# dset.xcorr_raytomoinput(outdir='/work3/leon/ray_tomo_data')
# # get field data for Eikonal tomography
# dset.xcorr_get_field()
# #################################################################################
# 
import raytomo
dset=raytomo.RayTomoDataSet('../ray_tomo_WUS_iso.h5')
dset.set_input_parameters(minlon=235., maxlon=255., minlat=31., maxlat=50., data_pfx='raytomo_in_', smoothpfx='N_INIT_', qcpfx='QC_')
dset.run_smooth(datadir='/work3/leon/ray_tomo_data', outdir='/work3/leon/ray_tomo_working_dir')
dset.run_qc(outdir='/work3/leon/ray_tomo_working_dir', isotropic=False, anipara=1, alphaAni4=1000)
...
#################################################################################
# import eikonaltomo
# dset=eikonaltomo.EikonalTomoDataSet('../eikonal_tomo_WUS_12sec.h5')
...
# # # print t2-t1
# # # # w, w2=dset.eikonal_stack_nb()
# dset._get_lon_lat_arr()
# dset.get_data4plot(period=12.)
# dset.np2ma()
