...
#initialization
#-----------------------
dset=raytomo.RayTomoDataSet('/work1/leon/ALASKA_work/hdf5_files/ray_tomo_Alaska_20190228_gr.h5')
# 
...
#-----------------------------------------------------
# dset.get_mask_inv(Tmin=8., Tmax=50., runid=2)

#-----------------------------------------------------
# interpolate to a given grid spacing
#-----------------------------------------------------
# dset.interp_surface(dlon=1., dlat=0.5, runid = 2)