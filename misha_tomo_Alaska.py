...
dset.set_input_parameters(minlon=188, maxlon=238, minlat=52, maxlat=72, data_pfx='raytomo_in_', smoothpfx='N_INIT_', qcpfx='QC_', pers=np.array([10.]))
...
dset.run_qc(outdir='../ray_tomo_working_dir', isotropic=True, anipara=0, alphaAni4=1000)
# 
